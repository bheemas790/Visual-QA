...
class Attention(nn.Module): # Extend PyTorch's Module class
    ...
    def forward(self, ques_feat, img_feat):  # ques_feat -- [batch, d] | img_feat -- [batch_size, m, d]
        ...
        ques_emb_1 = self.tan(self.dp(self.fc1_1a(ques_feat)))
        ques_emb_1 = self.tan(self.dp(self.fc1_1b(ques_emb_1))) 
        img_emb_1 = self.tan(self.dp(self.fc1_2a(img_feat)))
        img_emb_1 = self.tan(self.dp(self.fc1_2b(img_emb_1)))

        #print(img_emb_1.shape,ques_emb_1.shape)
        t1 = self.fc1_3a(ques_emb_1)

        #print(t1.shape,img_emb_1.shape)
        #pdb.set_trace()
        h1 = self.tan(t1.view(-1,1,self.att_size)  + img_emb_1)
        h1_emb = self.tan(self.dp(self.fc1_3b(h1)))
        ...
        #(Question embedding aware with image features)

        
        ques_emb_2 = self.tan(self.dp(self.fc2_1a(u1)))  # [batch_size, att_size]
        ques_emb_2 = self.tan(self.dp(self.fc2_1b(ques_emb_2)))
        img_emb_2 = self.tan(self.dp(self.fc2_2a(img_feat)))
        img_emb_2 = self.tan(self.dp(self.fc2_2b(img_emb_2)))

        h2 = self.tan(self.fc2_3a(ques_emb_2).view(-1,1,self.att_size) + img_emb_2)
        h2_emb = self.tan(self.dp(self.fc2_3b(h2)))
