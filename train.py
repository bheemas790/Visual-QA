...
from sans_model import VqaModel
...
def main(args):
    ...
    model = VqaModel(
        ...
        img_seq_size=args.img_seq_size).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_qst_length', type=int, default=26,
    ...
    parser.add_argument('--img_seq_size', default=196, type=int, 
                        help='number of feature regions in image')

    parser.add_argument('--att_size', default=512, type=int,
